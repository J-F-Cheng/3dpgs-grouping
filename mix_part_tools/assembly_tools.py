...
from .quaternion import qrot, recover_pc
...
def part_sel(conf, input_part_pcs: Tensor, poses: Tensor, pose_type):
    ...
    if conf.sel_first:
        ...
        elif pose_type=='qua' or pose_type=='euler_direct' or pose_type=='qua_artifact':
...
def assembly_parts(conf, sel_parts_poses, pose_type):
    ...
    elif pose_type == "qua_artifact":
        return recover_pc(conf, cur_input_parts, cur_poses)
